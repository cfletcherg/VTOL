classdef plotObserverData < handle
    ...
    methods
        ...
        %----------------------------
        function self = updatePlots(self, t, x, xhatlat, xhatlon)
            ...
            self.z_hat_history(self.index) = xhatlat(1);
            self.h_hat_history(self.index) = xhatlon(1);
            self.theta_hat_history(self.index) = 180/pi*xhatlat(2);
            self.z_hat_dot_history(self.index) = xhatlat(3);
            self.h_hat_dot_history(self.index) = xhatlon(2);
            self.theta_hat_dot_history(self.index) = 180/pi*xhatlat(4);
